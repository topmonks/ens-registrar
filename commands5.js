...
main = async () => {
  ...
  await registrar.methods.register(web3.utils.sha3("test"), namehash("test.topmonks.eth"), accounts[3])
  ...
  await registrar2.methods.register(web3.utils.sha3("monika"), namehash("monika.topmonks.eth"), accounts[4])
    .send({ from: accounts[4], gas: '6000000' });
